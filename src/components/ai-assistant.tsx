  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content:
        "Hi — I’m Cook Out Menu AI. Ask me about menu items, nutrition, prices, trays, shakes, locations or how to use this site.",
    },
  ]);
  ...
  return (
    <>
      {open && (
        <aside className="ai-panel" aria-label="Cook Out Menu AI">
          <div className="ai-panel-head">
            <div>
              ...
              <div>
                ...
                <small>Source-aware assistant</small>
              </div>
            </div>
            <button
              type="button"
          ...
          <div className="ai-disclaimer">
            Unofficial resource • AI can make mistakes • Verify important details with the restaurant.
          </div>
        </aside>
      )}
      ...
      {!embedded && (
        <button
          type="button"
          className={"ai-launcher " + (open ? "active" : "")}
          onClick={() => setOpen((value) => !value)}
          aria-label="Open Cook Out Menu AI"
        >
          <span className="ai-launcher-icon">✦</span>
          <span>
            <b>Ask AI</b>
            <small>Menu assistant</small>
          </span>
        </button>
      )}
    </>
